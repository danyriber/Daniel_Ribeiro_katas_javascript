...
const ciudades = ['Japón', 'Nicaragua', 'Suiza', 'Australia', 'Venezuela'];
...
const container2 = document.querySelector('[data-function="printHere"]');
...
countries.forEach(country => {
  ...
  botonEliminarDiv.textContent = 'Eliminar Div';
