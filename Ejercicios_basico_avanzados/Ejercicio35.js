...
mutantes si existe alguno con un poder específico y retorne un mensaje indicando si fue encontrado o no.
...
function findMutantByPower(mutants, power) {
    ...
    if (contador > 0) {
        return `Se encontraron ${contador} mutantes con el poder "${power}".`;
    } else {
